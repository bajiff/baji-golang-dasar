...
func latihanTiga(){
	...
	case "coocking": fmt.Print("Koki sedang memasak dengan api besar!.\n")
	case "ready": fmt.Print("Ting! Pesanan siap dihidangkan ke pelanggan.\n")
	case "pending": fmt.Print("Pesanan sedang disiapkan, koki sedang cuci tangan.\n")
	default: fmt.Print("Status pesanan tidak valid.\n") 
	}
}